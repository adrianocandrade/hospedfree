 ...
 */
import type {AdminHostingPlansProviderPackageBodyProvider} from './admin-hosting-plans-provider-package-body-provider';

export type AdminHostingPlansProviderPackageBody = {
  provider: AdminHostingPlansProviderPackageBodyProvider;
  /** @maxLength 120 */
