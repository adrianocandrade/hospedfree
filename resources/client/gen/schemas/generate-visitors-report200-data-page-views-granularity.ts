...
export type GenerateVisitorsReport200DataPageViewsGranularity =
  (typeof GenerateVisitorsReport200DataPageViewsGranularity)[keyof typeof GenerateVisitorsReport200DataPageViewsGranularity];

export const GenerateVisitorsReport200DataPageViewsGranularity = {
  minute: 'minute',
  hour: 'hour',
  day: 'day',
  week: 'week',
