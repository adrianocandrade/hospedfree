...
export type BiolinkThemeConfigBgConfigImageEffect =
  (typeof BiolinkThemeConfigBgConfigImageEffect)[keyof typeof BiolinkThemeConfigBgConfigImageEffect];

export const BiolinkThemeConfigBgConfigImageEffect = {
  mono: 'mono',
  blur: 'blur',
  halftone: 'halftone',
} as const;
