 ...
 */
import type {CrupdateBiolinkBodyRulesItemType} from './crupdate-biolink-body-rules-item-type';

export type CrupdateBiolinkBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: CrupdateBiolinkBodyRulesItemType;
};
