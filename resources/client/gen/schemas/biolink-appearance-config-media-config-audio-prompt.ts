 ...
 */
import type {BiolinkAppearanceConfigMediaConfigAudioPromptFontConfig} from './biolink-appearance-config-media-config-audio-prompt-font-config';

export type BiolinkAppearanceConfigMediaConfigAudioPrompt = {
  enabled?: boolean;
  text?: string;
  textColor?: string;
  fontConfig?: BiolinkAppearanceConfigMediaConfigAudioPromptFontConfig;
};
