...
export type CrupdateBiolinkLinkBodyRulesItemType =
  (typeof CrupdateBiolinkLinkBodyRulesItemType)[keyof typeof CrupdateBiolinkLinkBodyRulesItemType];

export const CrupdateBiolinkLinkBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
