...
export type BiolinkAppearanceConfigFooterConfigLinksItemVariant =
  (typeof BiolinkAppearanceConfigFooterConfigLinksItemVariant)[keyof typeof BiolinkAppearanceConfigFooterConfigLinksItemVariant];

export const BiolinkAppearanceConfigFooterConfigLinksItemVariant = {
  link: 'link',
  cta: 'cta',
} as const;
