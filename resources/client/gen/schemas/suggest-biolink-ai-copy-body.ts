 ...
 */
import type {SuggestBiolinkAiCopyBodyPurpose} from './suggest-biolink-ai-copy-body-purpose';
import type {SuggestBiolinkAiCopyBodyTone} from './suggest-biolink-ai-copy-body-tone';

export type SuggestBiolinkAiCopyBody = {
  purpose: SuggestBiolinkAiCopyBodyPurpose;
  /**
   * @minLength 2
   * @maxLength 2000
   */
  input: string;
  /** @nullable */
  tone?: SuggestBiolinkAiCopyBodyTone;
  /**
   * @maxLength 12
   * @nullable
