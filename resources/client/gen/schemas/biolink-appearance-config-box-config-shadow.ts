...
export type BiolinkAppearanceConfigBoxConfigShadow =
  (typeof BiolinkAppearanceConfigBoxConfigShadow)[keyof typeof BiolinkAppearanceConfigBoxConfigShadow];

export const BiolinkAppearanceConfigBoxConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
