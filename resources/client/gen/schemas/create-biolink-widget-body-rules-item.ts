 ...
 */
import type {CreateBiolinkWidgetBodyRulesItemType} from './create-biolink-widget-body-rules-item-type';

export type CreateBiolinkWidgetBodyRulesItem = {
  type: CreateBiolinkWidgetBodyRulesItemType;
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
