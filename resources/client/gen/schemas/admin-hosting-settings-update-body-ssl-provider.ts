...
export type AdminHostingSettingsUpdateBodySslProvider =
  (typeof AdminHostingSettingsUpdateBodySslProvider)[keyof typeof AdminHostingSettingsUpdateBodySslProvider];

export const AdminHostingSettingsUpdateBodySslProvider = {
  manual: 'manual',
  acme: 'acme',
} as const;
