 ...
 */
import type {ListCustomerSecurityEvents200MetaLinksItem} from './list-customer-security-events200-meta-links-item';

export type ListCustomerSecurityEvents200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: ListCustomerSecurityEvents200MetaLinksItem[];
  /**
