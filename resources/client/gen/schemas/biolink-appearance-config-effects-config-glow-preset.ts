...
export type BiolinkAppearanceConfigEffectsConfigGlowPreset =
  (typeof BiolinkAppearanceConfigEffectsConfigGlowPreset)[keyof typeof BiolinkAppearanceConfigEffectsConfigGlowPreset];

export const BiolinkAppearanceConfigEffectsConfigGlowPreset = {
  none: 'none',
  soft: 'soft',
  medium: 'medium',
  strong: 'strong',
