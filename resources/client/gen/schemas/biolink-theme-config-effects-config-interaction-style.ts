...
export type BiolinkThemeConfigEffectsConfigInteractionStyle =
  (typeof BiolinkThemeConfigEffectsConfigInteractionStyle)[keyof typeof BiolinkThemeConfigEffectsConfigInteractionStyle];

export const BiolinkThemeConfigEffectsConfigInteractionStyle = {
  lift: 'lift',
  press: 'press',
  quiet: 'quiet',
} as const;
