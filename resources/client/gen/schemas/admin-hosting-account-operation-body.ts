 ...
 */
import type {AdminHostingAccountOperationBodyOperation} from './admin-hosting-account-operation-body-operation';

export type AdminHostingAccountOperationBody = {
  operation: AdminHostingAccountOperationBodyOperation;
  /** @nullable */
