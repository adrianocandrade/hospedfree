...
export type BiolinkThemeMetadataDevice =
  (typeof BiolinkThemeMetadataDevice)[keyof typeof BiolinkThemeMetadataDevice];

export const BiolinkThemeMetadataDevice = {
  mobile: 'mobile',
  desktop: 'desktop',
  both: 'both',
} as const;
