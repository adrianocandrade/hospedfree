 ...
 */
import type {HostingDomainsVerify200DnsInstructionsItem} from './hosting-domains-verify200-dns-instructions-item';
import type {HostingDomainsVerify200DnsStatus} from './hosting-domains-verify200-dns-status';

export type HostingDomainsVerify200Dns = {
  status: HostingDomainsVerify200DnsStatus;
  retryable: string;
  safe_code: string;
  checked_at: string;
  instructions: HostingDomainsVerify200DnsInstructionsItem[];
};
