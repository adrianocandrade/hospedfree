 ...
 */
import type {GenerateVisitorsReport200Data} from './generate-visitors-report200-data';

export type GenerateVisitorsReport200 = {
  data: GenerateVisitorsReport200Data;
};
