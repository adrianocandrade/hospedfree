 ...
 */
import type {KnowledgeBaseIndex200MetaLinksItem} from './knowledge-base-index200-meta-links-item';

export type KnowledgeBaseIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: KnowledgeBaseIndex200MetaLinksItem[];
  /**
