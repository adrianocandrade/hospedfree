...
export type BiolinkThemeConfigDesktopConfigDecorativePlacement =
  (typeof BiolinkThemeConfigDesktopConfigDecorativePlacement)[keyof typeof BiolinkThemeConfigDesktopConfigDecorativePlacement];

export const BiolinkThemeConfigDesktopConfigDecorativePlacement = {
  left: 'left',
  right: 'right',
