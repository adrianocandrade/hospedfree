...
export type BiolinkAppearanceConfigHeaderConfigAlignment =
  (typeof BiolinkAppearanceConfigHeaderConfigAlignment)[keyof typeof BiolinkAppearanceConfigHeaderConfigAlignment];

export const BiolinkAppearanceConfigHeaderConfigAlignment = {
  center: 'center',
  left: 'left',
