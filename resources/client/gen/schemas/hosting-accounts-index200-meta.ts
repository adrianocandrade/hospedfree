 ...
 */
import type {HostingAccountsIndex200MetaLinksItem} from './hosting-accounts-index200-meta-links-item';

export type HostingAccountsIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: HostingAccountsIndex200MetaLinksItem[];
  /**
