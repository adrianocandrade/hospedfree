 ...
 */
import type {CrupdateLinkBodyRulesItemType} from './crupdate-link-body-rules-item-type';

export type CrupdateLinkBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: CrupdateLinkBodyRulesItemType;
};
