 ...
 */
import type {UpdateBiolinkAppearanceRequestConfig} from './update-biolink-appearance-request-config';

export type UpdateBiolinkAppearanceRequest = {
  config: UpdateBiolinkAppearanceRequestConfig;
};
