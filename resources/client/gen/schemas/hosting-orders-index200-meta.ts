 ...
 */
import type {HostingOrdersIndex200MetaLinksItem} from './hosting-orders-index200-meta-links-item';

export type HostingOrdersIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: HostingOrdersIndex200MetaLinksItem[];
  /**
