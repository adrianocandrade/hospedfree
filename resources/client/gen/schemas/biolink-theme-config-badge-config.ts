 ...
 */
import type {BiolinkThemeConfigBadgeConfigItemsItem} from './biolink-theme-config-badge-config-items-item';
import type {BiolinkThemeConfigBadgeConfigStyle} from './biolink-theme-config-badge-config-style';

export type BiolinkThemeConfigBadgeConfig = {
  style?: BiolinkThemeConfigBadgeConfigStyle;
  items?: BiolinkThemeConfigBadgeConfigItemsItem[];
};
