 ...
 */
import type {BiolinkAppearanceConfigEffectsConfigGlowPreset} from './biolink-appearance-config-effects-config-glow-preset';
import type {BiolinkAppearanceConfigEffectsConfigGlowSource} from './biolink-appearance-config-effects-config-glow-source';

export type BiolinkAppearanceConfigEffectsConfigGlow = {
  enabled?: boolean;
  preset?: BiolinkAppearanceConfigEffectsConfigGlowPreset;
  source?: BiolinkAppearanceConfigEffectsConfigGlowSource;
  customColor?: string;
  opacity?: number;
  blur?: number;
  spread?: number;
