...
export type BiolinkThemeConfigDesktopConfigContentMode =
  (typeof BiolinkThemeConfigDesktopConfigContentMode)[keyof typeof BiolinkThemeConfigDesktopConfigContentMode];

export const BiolinkThemeConfigDesktopConfigContentMode = {
  stack: 'stack',
  spotlight: 'spotlight',
  columns: 'columns',
} as const;
