 ...
 * @nullable
 */
export type SupportTicketsStoreBodyDepartment =
  | (typeof SupportTicketsStoreBodyDepartment)[keyof typeof SupportTicketsStoreBodyDepartment]
  | null;

export const SupportTicketsStoreBodyDepartment = {
  technical: 'technical',
  general: 'general',
  billing: 'billing',
} as const;
