...
export type BiolinkThemeConfigEffectsConfigGlowPreset =
  (typeof BiolinkThemeConfigEffectsConfigGlowPreset)[keyof typeof BiolinkThemeConfigEffectsConfigGlowPreset];

export const BiolinkThemeConfigEffectsConfigGlowPreset = {
  none: 'none',
  soft: 'soft',
  medium: 'medium',
  strong: 'strong',
