 ...
 */
import type {GetPublicBiolinkFeed200DataItemsItem} from './get-public-biolink-feed200-data-items-item';

export type GetPublicBiolinkFeed200Data = {
  title: string;
  items: GetPublicBiolinkFeed200DataItemsItem[];
};
