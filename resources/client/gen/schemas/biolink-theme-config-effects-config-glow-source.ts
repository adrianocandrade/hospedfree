...
export type BiolinkThemeConfigEffectsConfigGlowSource =
  (typeof BiolinkThemeConfigEffectsConfigGlowSource)[keyof typeof BiolinkThemeConfigEffectsConfigGlowSource];

export const BiolinkThemeConfigEffectsConfigGlowSource = {
  primary: 'primary',
  secondary: 'secondary',
  tertiary: 'tertiary',
  block: 'block',
