 ...
 * @nullable
 */
export type CrupdateQrCodeBodyDataSecurity =
  | (typeof CrupdateQrCodeBodyDataSecurity)[keyof typeof CrupdateQrCodeBodyDataSecurity]
  | null;

export const CrupdateQrCodeBodyDataSecurity = {
  WPA: 'WPA',
  WEP: 'WEP',
  nopass: 'nopass',
} as const;
