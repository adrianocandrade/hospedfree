...
export type BiolinkThemeConfigFooterConfigBrandSource =
  (typeof BiolinkThemeConfigFooterConfigBrandSource)[keyof typeof BiolinkThemeConfigFooterConfigBrandSource];

export const BiolinkThemeConfigFooterConfigBrandSource = {
  auto: 'auto',
  logo: 'logo',
  avatar: 'avatar',
} as const;
