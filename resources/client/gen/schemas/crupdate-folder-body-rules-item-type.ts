...
export type CrupdateFolderBodyRulesItemType =
  (typeof CrupdateFolderBodyRulesItemType)[keyof typeof CrupdateFolderBodyRulesItemType];

export const CrupdateFolderBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
