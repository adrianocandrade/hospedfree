...
export type BiolinkThemeConfigHeaderConfigAlignment =
  (typeof BiolinkThemeConfigHeaderConfigAlignment)[keyof typeof BiolinkThemeConfigHeaderConfigAlignment];

export const BiolinkThemeConfigHeaderConfigAlignment = {
  center: 'center',
  left: 'left',
