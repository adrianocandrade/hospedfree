...
import type {HostingAccountsIndex200Links} from './hosting-accounts-index200-links';
import type {HostingAccountsIndex200Meta} from './hosting-accounts-index200-meta';

export type HostingAccountsIndex200 = {
  data: HostingAccountResource[];
  links: HostingAccountsIndex200Links;
  meta: HostingAccountsIndex200Meta;
};
