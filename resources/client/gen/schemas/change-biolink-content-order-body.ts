 ...
 */
import type {ChangeBiolinkContentOrderBodyOrderItem} from './change-biolink-content-order-body-order-item';

export type ChangeBiolinkContentOrderBody = {
  widgetToPin?: number;
  /** @minItems 1 */
  order?: ChangeBiolinkContentOrderBodyOrderItem[];
};
