...
export type BiolinkAppearanceConfigSocialConfigDesktopPlacement =
  (typeof BiolinkAppearanceConfigSocialConfigDesktopPlacement)[keyof typeof BiolinkAppearanceConfigSocialConfigDesktopPlacement];

export const BiolinkAppearanceConfigSocialConfigDesktopPlacement = {
  badge: 'badge',
  footer: 'footer',
  hidden: 'hidden',
} as const;
