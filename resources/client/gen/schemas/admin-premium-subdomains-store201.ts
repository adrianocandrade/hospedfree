 ...
 */
import type {AdminPremiumSubdomainsStore201Data} from './admin-premium-subdomains-store201-data';

export type AdminPremiumSubdomainsStore201 = {
  data: AdminPremiumSubdomainsStore201Data;
};
