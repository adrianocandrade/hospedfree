...
import type {ListLinkPages200Links} from './list-link-pages200-links';
import type {ListLinkPages200Meta} from './list-link-pages200-meta';

export type ListLinkPages200 = {
  data: LinkPage[];
  links: ListLinkPages200Links;
  meta: ListLinkPages200Meta;
};
