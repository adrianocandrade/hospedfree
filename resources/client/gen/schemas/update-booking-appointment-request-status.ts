 ...
 * @nullable
 */
export type UpdateBookingAppointmentRequestStatus =
  | (typeof UpdateBookingAppointmentRequestStatus)[keyof typeof UpdateBookingAppointmentRequestStatus]
  | null;

export const UpdateBookingAppointmentRequestStatus = {
  confirmed: 'confirmed',
