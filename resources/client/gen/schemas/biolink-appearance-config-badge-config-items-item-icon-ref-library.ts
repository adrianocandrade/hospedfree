...
export type BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary =
  (typeof BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary)[keyof typeof BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary];

export const BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary = {
  lucide: 'lucide',
