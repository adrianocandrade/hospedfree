...
export type BiolinkThemeConfigEffectsConfigParticlePreset =
  (typeof BiolinkThemeConfigEffectsConfigParticlePreset)[keyof typeof BiolinkThemeConfigEffectsConfigParticlePreset];

export const BiolinkThemeConfigEffectsConfigParticlePreset = {
  none: 'none',
  stars: 'stars',
  particles: 'particles',
  snow: 'snow',
