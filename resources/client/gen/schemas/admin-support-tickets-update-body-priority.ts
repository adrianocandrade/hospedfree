...
export type AdminSupportTicketsUpdateBodyPriority =
  (typeof AdminSupportTicketsUpdateBodyPriority)[keyof typeof AdminSupportTicketsUpdateBodyPriority];

export const AdminSupportTicketsUpdateBodyPriority = {
  low: 'low',
  normal: 'normal',
  high: 'high',
  urgent: 'urgent',
