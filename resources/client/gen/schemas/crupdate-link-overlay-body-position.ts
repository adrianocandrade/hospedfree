...
export type CrupdateLinkOverlayBodyPosition =
  (typeof CrupdateLinkOverlayBodyPosition)[keyof typeof CrupdateLinkOverlayBodyPosition];

export const CrupdateLinkOverlayBodyPosition = {
  'top-left': 'top-left',
  'top-right': 'top-right',
