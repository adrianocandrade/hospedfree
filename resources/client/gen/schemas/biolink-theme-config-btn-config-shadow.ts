...
export type BiolinkThemeConfigBtnConfigShadow =
  (typeof BiolinkThemeConfigBtnConfigShadow)[keyof typeof BiolinkThemeConfigBtnConfigShadow];

export const BiolinkThemeConfigBtnConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
