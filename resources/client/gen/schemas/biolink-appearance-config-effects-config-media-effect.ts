...
export type BiolinkAppearanceConfigEffectsConfigMediaEffect =
  (typeof BiolinkAppearanceConfigEffectsConfigMediaEffect)[keyof typeof BiolinkAppearanceConfigEffectsConfigMediaEffect];

export const BiolinkAppearanceConfigEffectsConfigMediaEffect = {
  none: 'none',
  aurora: 'aurora',
  tv: 'tv',
  blur: 'blur',
