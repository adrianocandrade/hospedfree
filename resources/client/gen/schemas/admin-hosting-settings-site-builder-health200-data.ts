 ...
 */
import type {AdminHostingSettingsSiteBuilderHealth200DataStatus} from './admin-hosting-settings-site-builder-health200-data-status';

export type AdminHostingSettingsSiteBuilderHealth200Data = {
  success: boolean;
  retryable: string;
  code: string;
  status: AdminHostingSettingsSiteBuilderHealth200DataStatus;
