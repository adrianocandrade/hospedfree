...
export type BiolinkAppearanceConfigEffectsConfigGlowSource =
  (typeof BiolinkAppearanceConfigEffectsConfigGlowSource)[keyof typeof BiolinkAppearanceConfigEffectsConfigGlowSource];

export const BiolinkAppearanceConfigEffectsConfigGlowSource = {
  primary: 'primary',
  secondary: 'secondary',
  tertiary: 'tertiary',
  block: 'block',
