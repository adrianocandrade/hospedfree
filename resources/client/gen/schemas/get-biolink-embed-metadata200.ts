 ...
 */
import type {GetBiolinkEmbedMetadata200Provider} from './get-biolink-embed-metadata200-provider';

export type GetBiolinkEmbedMetadata200 = {
  url: string;
  name: string;
  /** @nullable */
  ...
  /** @nullable */
  image: string | null;
  provider: GetBiolinkEmbedMetadata200Provider;
  domain: string;
};
