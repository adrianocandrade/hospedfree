 ...
 */
import type {BiolinkThemeConfigBadgeConfigItemsItemIconRefLibrary} from './biolink-theme-config-badge-config-items-item-icon-ref-library';

export type BiolinkThemeConfigBadgeConfigItemsItemIconRef = {
  library: BiolinkThemeConfigBadgeConfigItemsItemIconRefLibrary;
  name: string;
};
