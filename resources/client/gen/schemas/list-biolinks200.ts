...
import type {ListBiolinks200Links} from './list-biolinks200-links';
import type {ListBiolinks200Meta} from './list-biolinks200-meta';

export type ListBiolinks200 = {
  data: Biolink[];
  links: ListBiolinks200Links;
  meta: ListBiolinks200Meta;
};
