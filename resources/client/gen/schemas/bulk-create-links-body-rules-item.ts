 ...
 */
import type {BulkCreateLinksBodyRulesItemType} from './bulk-create-links-body-rules-item-type';

export type BulkCreateLinksBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: BulkCreateLinksBodyRulesItemType;
};
