 ...
 * @nullable
 */
export type SupportTicketsStoreBodyPriority =
  | (typeof SupportTicketsStoreBodyPriority)[keyof typeof SupportTicketsStoreBodyPriority]
  | null;

export const SupportTicketsStoreBodyPriority = {
  low: 'low',
  normal: 'normal',
  high: 'high',
  urgent: 'urgent',
