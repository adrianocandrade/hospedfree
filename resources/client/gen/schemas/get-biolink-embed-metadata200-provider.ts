...
export type GetBiolinkEmbedMetadata200Provider =
  (typeof GetBiolinkEmbedMetadata200Provider)[keyof typeof GetBiolinkEmbedMetadata200Provider];

export const GetBiolinkEmbedMetadata200Provider = {
  instagram: 'instagram',
  tiktok: 'tiktok',
  youtube: 'youtube',
  facebook: 'facebook',
