...
export type BiolinkThemeConfigCardConfigCardVariant =
  (typeof BiolinkThemeConfigCardConfigCardVariant)[keyof typeof BiolinkThemeConfigCardConfigCardVariant];

export const BiolinkThemeConfigCardConfigCardVariant = {
  standard: 'standard',
  media: 'media',
  compact: 'compact',
  poster: 'poster',
