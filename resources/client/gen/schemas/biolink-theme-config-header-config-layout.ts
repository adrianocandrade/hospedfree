...
export type BiolinkThemeConfigHeaderConfigLayout =
  (typeof BiolinkThemeConfigHeaderConfigLayout)[keyof typeof BiolinkThemeConfigHeaderConfigLayout];

export const BiolinkThemeConfigHeaderConfigLayout = {
  classic: 'classic',
  hero: 'hero',
  banner: 'banner',
  cutout: 'cutout',
