...
export type AdminHostingAccountOperationBodyOperation =
  (typeof AdminHostingAccountOperationBodyOperation)[keyof typeof AdminHostingAccountOperationBodyOperation];

export const AdminHostingAccountOperationBodyOperation = {
  reconcile: 'reconcile',
  suspend: 'suspend',
  unsuspend: 'unsuspend',
  delete: 'delete',
