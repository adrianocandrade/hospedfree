...
export type BiolinkAppearanceConfigCardConfigImagePosition =
  (typeof BiolinkAppearanceConfigCardConfigImagePosition)[keyof typeof BiolinkAppearanceConfigCardConfigImagePosition];

export const BiolinkAppearanceConfigCardConfigImagePosition = {
  left: 'left',
  top: 'top',
} as const;
