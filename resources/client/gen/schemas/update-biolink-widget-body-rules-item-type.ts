...
export type UpdateBiolinkWidgetBodyRulesItemType =
  (typeof UpdateBiolinkWidgetBodyRulesItemType)[keyof typeof UpdateBiolinkWidgetBodyRulesItemType];

export const UpdateBiolinkWidgetBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
