...
export type CrupdateLinkBodyRulesItemType =
  (typeof CrupdateLinkBodyRulesItemType)[keyof typeof CrupdateLinkBodyRulesItemType];

export const CrupdateLinkBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
