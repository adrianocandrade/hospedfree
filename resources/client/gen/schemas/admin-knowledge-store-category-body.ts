 ...
 */
import type {AdminKnowledgeStoreCategoryBodyStatus} from './admin-knowledge-store-category-body-status';

export type AdminKnowledgeStoreCategoryBody = {
  /** @maxLength 160 */
  name: string;
  /**
   * @maxLength 1000
  ...
  /** @nullable */
  status?: AdminKnowledgeStoreCategoryBodyStatus;
  /**
   * @minimum 0
   * @maximum 65535
   * @nullable
