...
export type BiolinkThemeConfigFooterConfigLinksItemVariant =
  (typeof BiolinkThemeConfigFooterConfigLinksItemVariant)[keyof typeof BiolinkThemeConfigFooterConfigLinksItemVariant];

export const BiolinkThemeConfigFooterConfigLinksItemVariant = {
  link: 'link',
  cta: 'cta',
} as const;
