 ...
 */
import type {BookingAppointmentsIndex200MetaLinksItem} from './booking-appointments-index200-meta-links-item';

export type BookingAppointmentsIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: BookingAppointmentsIndex200MetaLinksItem[];
  /**
