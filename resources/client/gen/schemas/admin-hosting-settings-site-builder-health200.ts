 ...
 */
import type {AdminHostingSettingsSiteBuilderHealth200Data} from './admin-hosting-settings-site-builder-health200-data';

export type AdminHostingSettingsSiteBuilderHealth200 = {
  data: AdminHostingSettingsSiteBuilderHealth200Data;
};
