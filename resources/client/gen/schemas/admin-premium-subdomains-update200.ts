 ...
 */
import type {AdminPremiumSubdomainsUpdate200Data} from './admin-premium-subdomains-update200-data';

export type AdminPremiumSubdomainsUpdate200 = {
  data: AdminPremiumSubdomainsUpdate200Data;
};
