...
export type BiolinkThemeConfigEffectsConfigUsernameEffect =
  (typeof BiolinkThemeConfigEffectsConfigUsernameEffect)[keyof typeof BiolinkThemeConfigEffectsConfigUsernameEffect];

export const BiolinkThemeConfigEffectsConfigUsernameEffect = {
  none: 'none',
  glow: 'glow',
  pulse: 'pulse',
  scanline: 'scanline',
