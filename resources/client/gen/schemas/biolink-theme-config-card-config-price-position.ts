...
export type BiolinkThemeConfigCardConfigPricePosition =
  (typeof BiolinkThemeConfigCardConfigPricePosition)[keyof typeof BiolinkThemeConfigCardConfigPricePosition];

export const BiolinkThemeConfigCardConfigPricePosition = {
  inline: 'inline',
  right: 'right',
  below: 'below',
} as const;
