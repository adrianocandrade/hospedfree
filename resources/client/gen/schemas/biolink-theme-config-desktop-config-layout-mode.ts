...
export type BiolinkThemeConfigDesktopConfigLayoutMode =
  (typeof BiolinkThemeConfigDesktopConfigLayoutMode)[keyof typeof BiolinkThemeConfigDesktopConfigLayoutMode];

export const BiolinkThemeConfigDesktopConfigLayoutMode = {
  full: 'full',
  split: 'split',
} as const;
