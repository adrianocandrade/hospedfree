 ...
 */
import type {SuggestBiolinkAiCopy200DataUsage} from './suggest-biolink-ai-copy200-data-usage';

export type SuggestBiolinkAiCopy200Data = {
  suggestion: string;
  usage: SuggestBiolinkAiCopy200DataUsage;
};
