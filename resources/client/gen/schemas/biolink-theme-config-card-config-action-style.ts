...
export type BiolinkThemeConfigCardConfigActionStyle =
  (typeof BiolinkThemeConfigCardConfigActionStyle)[keyof typeof BiolinkThemeConfigCardConfigActionStyle];

export const BiolinkThemeConfigCardConfigActionStyle = {
  button: 'button',
  icon: 'icon',
  text: 'text',
} as const;
