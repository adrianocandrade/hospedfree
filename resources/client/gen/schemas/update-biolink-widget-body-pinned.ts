 ...
 * @nullable
 */
export type UpdateBiolinkWidgetBodyPinned =
  | (typeof UpdateBiolinkWidgetBodyPinned)[keyof typeof UpdateBiolinkWidgetBodyPinned]
  | null;

export const UpdateBiolinkWidgetBodyPinned = {
  top: 'top',
  bottom: 'bottom',
} as const;
