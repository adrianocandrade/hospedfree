...
export type BiolinkAppearanceConfigSocialConfigMobilePlacement =
  (typeof BiolinkAppearanceConfigSocialConfigMobilePlacement)[keyof typeof BiolinkAppearanceConfigSocialConfigMobilePlacement];

export const BiolinkAppearanceConfigSocialConfigMobilePlacement = {
  header: 'header',
  footer: 'footer',
  hidden: 'hidden',
} as const;
