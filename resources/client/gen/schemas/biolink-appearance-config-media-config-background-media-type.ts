...
export type BiolinkAppearanceConfigMediaConfigBackgroundMediaType =
  (typeof BiolinkAppearanceConfigMediaConfigBackgroundMediaType)[keyof typeof BiolinkAppearanceConfigMediaConfigBackgroundMediaType];

export const BiolinkAppearanceConfigMediaConfigBackgroundMediaType = {
  image: 'image',
  video: 'video',
} as const;
