 ...
 */
import type {AdminHostingSettingsFileManagerHealth200Data} from './admin-hosting-settings-file-manager-health200-data';

export type AdminHostingSettingsFileManagerHealth200 = {
  data: AdminHostingSettingsFileManagerHealth200Data;
};
