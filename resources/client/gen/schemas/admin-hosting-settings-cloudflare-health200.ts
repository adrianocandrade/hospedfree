 ...
 */
import type {AdminHostingSettingsCloudflareHealth200Data} from './admin-hosting-settings-cloudflare-health200-data';

export type AdminHostingSettingsCloudflareHealth200 = {
  data: AdminHostingSettingsCloudflareHealth200Data;
};
