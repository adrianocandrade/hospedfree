 ...
 * @nullable
 */
export type AdminKnowledgeStoreCategoryBodyStatus =
  | (typeof AdminKnowledgeStoreCategoryBodyStatus)[keyof typeof AdminKnowledgeStoreCategoryBodyStatus]
  | null;

export const AdminKnowledgeStoreCategoryBodyStatus = {
  draft: 'draft',
  published: 'published',
} as const;
