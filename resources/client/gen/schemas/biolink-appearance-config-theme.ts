 ...
 */
import type {BiolinkAppearanceConfigThemeCategory} from './biolink-appearance-config-theme-category';

export type BiolinkAppearanceConfigTheme = {
  slug?: string;
  category?: BiolinkAppearanceConfigThemeCategory;
  locked?: boolean;
  modified?: boolean;
};
