...
export type AdminHostingSettingsCloudflareHealth200DataStatus =
  (typeof AdminHostingSettingsCloudflareHealth200DataStatus)[keyof typeof AdminHostingSettingsCloudflareHealth200DataStatus];

export const AdminHostingSettingsCloudflareHealth200DataStatus = {
  available: 'available',
