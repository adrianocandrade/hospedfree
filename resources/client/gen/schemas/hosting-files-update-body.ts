 ...
 */
import type {HostingFilesUpdateBodyOperation} from './hosting-files-update-body-operation';

export type HostingFilesUpdateBody = {
  /** @maxLength 1024 */
  path: string;
  operation: HostingFilesUpdateBodyOperation;
  /**
   * @maxLength 1048576
   * @nullable
   */
