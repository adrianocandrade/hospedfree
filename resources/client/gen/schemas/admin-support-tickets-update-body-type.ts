...
export type AdminSupportTicketsUpdateBodyType =
  (typeof AdminSupportTicketsUpdateBodyType)[keyof typeof AdminSupportTicketsUpdateBodyType];

export const AdminSupportTicketsUpdateBodyType = {
  ticket: 'ticket',
  bug: 'bug',
  feature: 'feature',
} as const;
