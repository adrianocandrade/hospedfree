...
export type BiolinkAppearanceConfigBgConfigActiveType =
  (typeof BiolinkAppearanceConfigBgConfigActiveType)[keyof typeof BiolinkAppearanceConfigBgConfigActiveType];

export const BiolinkAppearanceConfigBgConfigActiveType = {
  color: 'color',
  pattern: 'pattern',
  gradient: 'gradient',
  image: 'image',
