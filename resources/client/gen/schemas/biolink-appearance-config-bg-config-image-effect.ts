...
export type BiolinkAppearanceConfigBgConfigImageEffect =
  (typeof BiolinkAppearanceConfigBgConfigImageEffect)[keyof typeof BiolinkAppearanceConfigBgConfigImageEffect];

export const BiolinkAppearanceConfigBgConfigImageEffect = {
  mono: 'mono',
  blur: 'blur',
  halftone: 'halftone',
} as const;
