 ...
 */
import type {BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary} from './biolink-appearance-config-badge-config-items-item-icon-ref-library';

export type BiolinkAppearanceConfigBadgeConfigItemsItemIconRef = {
  library: BiolinkAppearanceConfigBadgeConfigItemsItemIconRefLibrary;
  name: string;
};
