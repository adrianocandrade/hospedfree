 ...
 */
import type {GenerateTrackedEventsReport200DataCountriesDataItem} from './generate-tracked-events-report200-data-countries-data-item';

export type GenerateTrackedEventsReport200DataCountries = {
  data: GenerateTrackedEventsReport200DataCountriesDataItem[];
};
