 ...
 */
import type {CrupdateFolderBodyRulesItemType} from './crupdate-folder-body-rules-item-type';

export type CrupdateFolderBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: CrupdateFolderBodyRulesItemType;
};
