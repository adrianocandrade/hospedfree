...
export type UpdateBookingAvailabilityRequestExceptionsItemType =
  (typeof UpdateBookingAvailabilityRequestExceptionsItemType)[keyof typeof UpdateBookingAvailabilityRequestExceptionsItemType];

export const UpdateBookingAvailabilityRequestExceptionsItemType = {
  closed: 'closed',
  open: 'open',
  break: 'break',
} as const;
