...
export type BiolinkThemeConfigBtnConfigVariant =
  (typeof BiolinkThemeConfigBtnConfigVariant)[keyof typeof BiolinkThemeConfigBtnConfigVariant];

export const BiolinkThemeConfigBtnConfigVariant = {
  outline: 'outline',
  solid: 'solid',
  glass: 'glass',
