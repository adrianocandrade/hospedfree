 ...
 */
import type {AdminSupportTicketsIndex200MetaLinksItem} from './admin-support-tickets-index200-meta-links-item';

export type AdminSupportTicketsIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: AdminSupportTicketsIndex200MetaLinksItem[];
  /**
