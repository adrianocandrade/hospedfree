...
export type BiolinkAppearanceConfigSocialConfigStyle =
  (typeof BiolinkAppearanceConfigSocialConfigStyle)[keyof typeof BiolinkAppearanceConfigSocialConfigStyle];

export const BiolinkAppearanceConfigSocialConfigStyle = {
  icons: 'icons',
  buttons: 'buttons',
  pills: 'pills',
} as const;
