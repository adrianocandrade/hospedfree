...
export type BiolinkAppearanceConfigHeaderConfigTitleStyle =
  (typeof BiolinkAppearanceConfigHeaderConfigTitleStyle)[keyof typeof BiolinkAppearanceConfigHeaderConfigTitleStyle];

export const BiolinkAppearanceConfigHeaderConfigTitleStyle = {
  text: 'text',
  logo: 'logo',
} as const;
