...
export type BiolinkThemeConfigDesktopConfigSurfaceMode =
  (typeof BiolinkThemeConfigDesktopConfigSurfaceMode)[keyof typeof BiolinkThemeConfigDesktopConfigSurfaceMode];

export const BiolinkThemeConfigDesktopConfigSurfaceMode = {
  open: 'open',
  tinted: 'tinted',
} as const;
