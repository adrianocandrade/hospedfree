 ...
 */
import type {ListBiolinkThemesCategory} from './list-biolink-themes-category';
import type {ListBiolinkThemesDevice} from './list-biolink-themes-device';

export type ListBiolinkThemesParams = {
  /**
   * @nullable
   */
  include_unpublished?: boolean | null;
  /**
   * @nullable
   */
  models_only?: boolean | null;
  /**
   * @nullable
   */
  category?: ListBiolinkThemesCategory;
  /**
   * @nullable
   */
  device?: ListBiolinkThemesDevice;
  /**
   * @nullable
   */
