...
export type AdminPremiumSubdomainsUpdate200DataStatus =
  (typeof AdminPremiumSubdomainsUpdate200DataStatus)[keyof typeof AdminPremiumSubdomainsUpdate200DataStatus];

export const AdminPremiumSubdomainsUpdate200DataStatus = {
  inactive: 'inactive',
  expired: 'expired',
  paid: 'paid',
