...
export type CrupdateLinkOverlayBodyTheme =
  (typeof CrupdateLinkOverlayBodyTheme)[keyof typeof CrupdateLinkOverlayBodyTheme];

export const CrupdateLinkOverlayBodyTheme = {
  default: 'default',
