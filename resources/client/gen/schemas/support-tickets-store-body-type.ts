 ...
 * @nullable
 */
export type SupportTicketsStoreBodyType =
  | (typeof SupportTicketsStoreBodyType)[keyof typeof SupportTicketsStoreBodyType]
  | null;

export const SupportTicketsStoreBodyType = {
  ticket: 'ticket',
  bug: 'bug',
  feature: 'feature',
} as const;
