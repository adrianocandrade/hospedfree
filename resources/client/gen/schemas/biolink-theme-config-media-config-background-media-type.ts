...
export type BiolinkThemeConfigMediaConfigBackgroundMediaType =
  (typeof BiolinkThemeConfigMediaConfigBackgroundMediaType)[keyof typeof BiolinkThemeConfigMediaConfigBackgroundMediaType];

export const BiolinkThemeConfigMediaConfigBackgroundMediaType = {
  image: 'image',
  video: 'video',
} as const;
