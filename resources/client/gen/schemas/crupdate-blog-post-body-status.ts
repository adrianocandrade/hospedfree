...
export type CrupdateBlogPostBodyStatus =
  (typeof CrupdateBlogPostBodyStatus)[keyof typeof CrupdateBlogPostBodyStatus];

export const CrupdateBlogPostBodyStatus = {
  draft: 'draft',
  published: 'published',
} as const;
