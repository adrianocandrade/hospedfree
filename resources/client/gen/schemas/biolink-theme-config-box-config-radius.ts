...
export type BiolinkThemeConfigBoxConfigRadius =
  (typeof BiolinkThemeConfigBoxConfigRadius)[keyof typeof BiolinkThemeConfigBoxConfigRadius];

export const BiolinkThemeConfigBoxConfigRadius = {
