...
export type BiolinkAppearanceConfigHeaderConfigShapeVariant =
  (typeof BiolinkAppearanceConfigHeaderConfigShapeVariant)[keyof typeof BiolinkAppearanceConfigHeaderConfigShapeVariant];

export const BiolinkAppearanceConfigHeaderConfigShapeVariant = {
  loop: 'loop',
  flower: 'flower',
  oval: 'oval',
  rounded: 'rounded',
