...
export type BiolinkThemeConfigBadgeConfigStyle =
  (typeof BiolinkThemeConfigBadgeConfigStyle)[keyof typeof BiolinkThemeConfigBadgeConfigStyle];

export const BiolinkThemeConfigBadgeConfigStyle = {
  inline: 'inline',
  chips: 'chips',
  cards: 'cards',
  icon: 'icon',
