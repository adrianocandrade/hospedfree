...
export type BiolinkAppearanceConfigDesktopConfigDecorativePlacement =
  (typeof BiolinkAppearanceConfigDesktopConfigDecorativePlacement)[keyof typeof BiolinkAppearanceConfigDesktopConfigDecorativePlacement];

export const BiolinkAppearanceConfigDesktopConfigDecorativePlacement = {
  left: 'left',
  right: 'right',
