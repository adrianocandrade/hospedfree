 ...
 */
import type {ListQrCodes200Links} from './list-qr-codes200-links';
import type {ListQrCodes200Meta} from './list-qr-codes200-meta';
import type {QrCode} from './qr-code';

export type ListQrCodes200 = {
  data: QrCode[];
  links: ListQrCodes200Links;
  meta: ListQrCodes200Meta;
};
