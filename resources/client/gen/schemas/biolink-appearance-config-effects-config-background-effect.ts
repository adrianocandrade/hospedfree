...
export type BiolinkAppearanceConfigEffectsConfigBackgroundEffect =
  (typeof BiolinkAppearanceConfigEffectsConfigBackgroundEffect)[keyof typeof BiolinkAppearanceConfigEffectsConfigBackgroundEffect];

export const BiolinkAppearanceConfigEffectsConfigBackgroundEffect = {
  none: 'none',
  stars: 'stars',
  aurora: 'aurora',
  particles: 'particles',
