...
export type AdminHostingSettingsUpdateBodyProviderDriver =
  (typeof AdminHostingSettingsUpdateBodyProviderDriver)[keyof typeof AdminHostingSettingsUpdateBodyProviderDriver];

export const AdminHostingSettingsUpdateBodyProviderDriver = {
  fake: 'fake',
  mofh: 'mofh',
} as const;
