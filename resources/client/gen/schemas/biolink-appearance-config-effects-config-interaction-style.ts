...
export type BiolinkAppearanceConfigEffectsConfigInteractionStyle =
  (typeof BiolinkAppearanceConfigEffectsConfigInteractionStyle)[keyof typeof BiolinkAppearanceConfigEffectsConfigInteractionStyle];

export const BiolinkAppearanceConfigEffectsConfigInteractionStyle = {
  lift: 'lift',
  press: 'press',
  quiet: 'quiet',
} as const;
