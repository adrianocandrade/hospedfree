 ...
 */
import type {HostingHostingPremiumSubdomainPurchase200Premium} from './hosting-hosting-premium-subdomain-purchase200-premium';

export type HostingHostingPremiumSubdomainPurchase200 = {
  subdomain: string;
  fqdn: string;
  premium: HostingHostingPremiumSubdomainPurchase200Premium;
};
