 ...
 */
import type {AdminKnowledgeIndex200MetaLinksItem} from './admin-knowledge-index200-meta-links-item';

export type AdminKnowledgeIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: AdminKnowledgeIndex200MetaLinksItem[];
  /**
