 ...
 */
import type {BiolinkAppearanceConfigBadgeConfigItemsItem} from './biolink-appearance-config-badge-config-items-item';
import type {BiolinkAppearanceConfigBadgeConfigStyle} from './biolink-appearance-config-badge-config-style';

export type BiolinkAppearanceConfigBadgeConfig = {
  style?: BiolinkAppearanceConfigBadgeConfigStyle;
  items?: BiolinkAppearanceConfigBadgeConfigItemsItem[];
};
