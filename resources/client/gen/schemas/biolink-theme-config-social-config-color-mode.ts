...
export type BiolinkThemeConfigSocialConfigColorMode =
  (typeof BiolinkThemeConfigSocialConfigColorMode)[keyof typeof BiolinkThemeConfigSocialConfigColorMode];

export const BiolinkThemeConfigSocialConfigColorMode = {
  theme: 'theme',
  brand: 'brand',
