...
export type BiolinkThemeConfigBoxConfigVariant =
  (typeof BiolinkThemeConfigBoxConfigVariant)[keyof typeof BiolinkThemeConfigBoxConfigVariant];

export const BiolinkThemeConfigBoxConfigVariant = {
  outline: 'outline',
  solid: 'solid',
  glass: 'glass',
