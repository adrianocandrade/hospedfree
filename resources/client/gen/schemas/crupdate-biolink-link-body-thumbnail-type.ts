 ...
 * @nullable
 */
export type CrupdateBiolinkLinkBodyThumbnailType =
  | (typeof CrupdateBiolinkLinkBodyThumbnailType)[keyof typeof CrupdateBiolinkLinkBodyThumbnailType]
  | null;

export const CrupdateBiolinkLinkBodyThumbnailType = {
  image: 'image',
  asset: 'asset',
  none: 'none',
} as const;
