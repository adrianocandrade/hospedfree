 ...
 */
import type {GenerateTrackedEventsReport200Data} from './generate-tracked-events-report200-data';

export type GenerateTrackedEventsReport200 = {
  data: GenerateTrackedEventsReport200Data;
};
