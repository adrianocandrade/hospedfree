...
export type BiolinkAppearanceConfigHeaderConfigLayout =
  (typeof BiolinkAppearanceConfigHeaderConfigLayout)[keyof typeof BiolinkAppearanceConfigHeaderConfigLayout];

export const BiolinkAppearanceConfigHeaderConfigLayout = {
  classic: 'classic',
  hero: 'hero',
  banner: 'banner',
  cutout: 'cutout',
