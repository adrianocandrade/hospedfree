...
export type AdminHostingSettingsUpdateBodyFileManagerEditorTheme =
  (typeof AdminHostingSettingsUpdateBodyFileManagerEditorTheme)[keyof typeof AdminHostingSettingsUpdateBodyFileManagerEditorTheme];

export const AdminHostingSettingsUpdateBodyFileManagerEditorTheme = {
  auto: 'auto',
  chrome: 'chrome',
  monokai: 'monokai',
