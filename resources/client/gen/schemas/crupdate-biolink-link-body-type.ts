...
export type CrupdateBiolinkLinkBodyType =
  (typeof CrupdateBiolinkLinkBodyType)[keyof typeof CrupdateBiolinkLinkBodyType];

export const CrupdateBiolinkLinkBodyType = {
  direct: 'direct',
  frame: 'frame',
  overlay: 'overlay',
  splash: 'splash',
