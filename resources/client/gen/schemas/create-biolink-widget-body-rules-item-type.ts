...
export type CreateBiolinkWidgetBodyRulesItemType =
  (typeof CreateBiolinkWidgetBodyRulesItemType)[keyof typeof CreateBiolinkWidgetBodyRulesItemType];

export const CreateBiolinkWidgetBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
