...
export type BiolinkAppearanceConfigHeaderConfigBannerBackgroundType =
  (typeof BiolinkAppearanceConfigHeaderConfigBannerBackgroundType)[keyof typeof BiolinkAppearanceConfigHeaderConfigBannerBackgroundType];

export const BiolinkAppearanceConfigHeaderConfigBannerBackgroundType = {
  gradient: 'gradient',
  image: 'image',
} as const;
