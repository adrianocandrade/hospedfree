 ...
 */
import type {HostingSslAdminDestroy200Message} from './hosting-ssl-admin-destroy200-message';

export type HostingSslAdminDestroy200 = {
  message: HostingSslAdminDestroy200Message;
};
