 ...
 */
import type {UpdateBookingAppointmentRequestStatus} from './update-booking-appointment-request-status';

export type UpdateBookingAppointmentRequest = {
  /** @nullable */
  status?: UpdateBookingAppointmentRequestStatus;
  /** @nullable */
  date?: string | null;
  /** @nullable */
  time?: string | null;
