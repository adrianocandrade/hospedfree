...
export type BiolinkThemeConfigBoxConfigShadow =
  (typeof BiolinkThemeConfigBoxConfigShadow)[keyof typeof BiolinkThemeConfigBoxConfigShadow];

export const BiolinkThemeConfigBoxConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
