...
export type BiolinkThemeConfigBadgeConfigItemsItemType =
  (typeof BiolinkThemeConfigBadgeConfigItemsItemType)[keyof typeof BiolinkThemeConfigBadgeConfigItemsItemType];

export const BiolinkThemeConfigBadgeConfigItemsItemType = {
  system: 'system',
  custom: 'custom',
} as const;
