...
export type BiolinkAppearanceConfigDesktopConfigProfilePlacement =
  (typeof BiolinkAppearanceConfigDesktopConfigProfilePlacement)[keyof typeof BiolinkAppearanceConfigDesktopConfigProfilePlacement];

export const BiolinkAppearanceConfigDesktopConfigProfilePlacement = {
  center: 'center',
  left: 'left',
  right: 'right',
} as const;
