...
export type BiolinkAppearanceConfigDesktopConfigSurfaceMode =
  (typeof BiolinkAppearanceConfigDesktopConfigSurfaceMode)[keyof typeof BiolinkAppearanceConfigDesktopConfigSurfaceMode];

export const BiolinkAppearanceConfigDesktopConfigSurfaceMode = {
  open: 'open',
  tinted: 'tinted',
} as const;
