...
export type BiolinkThemeConfigSocialConfigStyle =
  (typeof BiolinkThemeConfigSocialConfigStyle)[keyof typeof BiolinkThemeConfigSocialConfigStyle];

export const BiolinkThemeConfigSocialConfigStyle = {
  icons: 'icons',
  buttons: 'buttons',
  pills: 'pills',
} as const;
