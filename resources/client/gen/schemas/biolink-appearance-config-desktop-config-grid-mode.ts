...
export type BiolinkAppearanceConfigDesktopConfigGridMode =
  (typeof BiolinkAppearanceConfigDesktopConfigGridMode)[keyof typeof BiolinkAppearanceConfigDesktopConfigGridMode];

export const BiolinkAppearanceConfigDesktopConfigGridMode = {
  auto: 'auto',
  NUMBER_1: '1',
  NUMBER_2: '2',
  NUMBER_3: '3',
