...
export type BiolinkThemeConfigDesktopConfigProfilePlacement =
  (typeof BiolinkThemeConfigDesktopConfigProfilePlacement)[keyof typeof BiolinkThemeConfigDesktopConfigProfilePlacement];

export const BiolinkThemeConfigDesktopConfigProfilePlacement = {
  center: 'center',
  left: 'left',
  right: 'right',
} as const;
