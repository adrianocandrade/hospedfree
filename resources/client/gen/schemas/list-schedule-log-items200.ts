 ...
 */
import type {ListScheduleLogItems200Links} from './list-schedule-log-items200-links';
import type {ListScheduleLogItems200Meta} from './list-schedule-log-items200-meta';
import type {ScheduleLogItem} from './schedule-log-item';

export type ListScheduleLogItems200 = {
  data: ScheduleLogItem[];
  links: ListScheduleLogItems200Links;
  meta: ListScheduleLogItems200Meta;
};
