...
export type BiolinkThemeConfigCardConfigImagePosition =
  (typeof BiolinkThemeConfigCardConfigImagePosition)[keyof typeof BiolinkThemeConfigCardConfigImagePosition];

export const BiolinkThemeConfigCardConfigImagePosition = {
  left: 'left',
  top: 'top',
} as const;
