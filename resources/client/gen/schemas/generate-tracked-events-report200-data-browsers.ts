 ...
 */
import type {GenerateTrackedEventsReport200DataBrowsersDataItem} from './generate-tracked-events-report200-data-browsers-data-item';

export type GenerateTrackedEventsReport200DataBrowsers = {
  data: GenerateTrackedEventsReport200DataBrowsersDataItem[];
};
