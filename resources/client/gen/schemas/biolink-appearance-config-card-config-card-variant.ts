...
export type BiolinkAppearanceConfigCardConfigCardVariant =
  (typeof BiolinkAppearanceConfigCardConfigCardVariant)[keyof typeof BiolinkAppearanceConfigCardConfigCardVariant];

export const BiolinkAppearanceConfigCardConfigCardVariant = {
  standard: 'standard',
  media: 'media',
  compact: 'compact',
  poster: 'poster',
