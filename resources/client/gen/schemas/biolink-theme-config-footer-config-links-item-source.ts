...
export type BiolinkThemeConfigFooterConfigLinksItemSource =
  (typeof BiolinkThemeConfigFooterConfigLinksItemSource)[keyof typeof BiolinkThemeConfigFooterConfigLinksItemSource];

export const BiolinkThemeConfigFooterConfigLinksItemSource = {
  url: 'url',
  widget: 'widget',
} as const;
