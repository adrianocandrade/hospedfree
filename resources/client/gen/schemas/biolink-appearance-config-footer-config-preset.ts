...
export type BiolinkAppearanceConfigFooterConfigPreset =
  (typeof BiolinkAppearanceConfigFooterConfigPreset)[keyof typeof BiolinkAppearanceConfigFooterConfigPreset];

export const BiolinkAppearanceConfigFooterConfigPreset = {
  compact: 'compact',
  community: 'community',
