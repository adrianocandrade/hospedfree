...
export type BiolinkThemeConfigFooterConfigPreset =
  (typeof BiolinkThemeConfigFooterConfigPreset)[keyof typeof BiolinkThemeConfigFooterConfigPreset];

export const BiolinkThemeConfigFooterConfigPreset = {
  compact: 'compact',
  community: 'community',
