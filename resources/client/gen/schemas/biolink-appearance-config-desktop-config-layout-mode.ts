...
export type BiolinkAppearanceConfigDesktopConfigLayoutMode =
  (typeof BiolinkAppearanceConfigDesktopConfigLayoutMode)[keyof typeof BiolinkAppearanceConfigDesktopConfigLayoutMode];

export const BiolinkAppearanceConfigDesktopConfigLayoutMode = {
  full: 'full',
  split: 'split',
} as const;
