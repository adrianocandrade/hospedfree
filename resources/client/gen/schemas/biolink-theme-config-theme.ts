 ...
 */
import type {BiolinkThemeConfigThemeCategory} from './biolink-theme-config-theme-category';

export type BiolinkThemeConfigTheme = {
  slug?: string;
  category?: BiolinkThemeConfigThemeCategory;
  locked?: boolean;
  modified?: boolean;
};
