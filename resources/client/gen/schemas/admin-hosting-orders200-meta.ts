 ...
 */
import type {AdminHostingOrders200MetaLinksItem} from './admin-hosting-orders200-meta-links-item';

export type AdminHostingOrders200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: AdminHostingOrders200MetaLinksItem[];
  /**
