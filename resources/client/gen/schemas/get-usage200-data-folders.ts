 ...
 */
import type {GetUsage200DataFoldersCreate} from './get-usage200-data-folders-create';
import type {GetUsage200DataFoldersDelete} from './get-usage200-data-folders-delete';
import type {GetUsage200DataFoldersUpdate} from './get-usage200-data-folders-update';

export type GetUsage200DataFolders = {
  used: number;
  /** @nullable */
  total: number | null;
  create: GetUsage200DataFoldersCreate;
  delete: GetUsage200DataFoldersDelete;
  update: GetUsage200DataFoldersUpdate;
};
