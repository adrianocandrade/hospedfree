...
export type BiolinkAppearanceConfigCardConfigImageSize =
  (typeof BiolinkAppearanceConfigCardConfigImageSize)[keyof typeof BiolinkAppearanceConfigCardConfigImageSize];

export const BiolinkAppearanceConfigCardConfigImageSize = {
  small: 'small',
  medium: 'medium',
  large: 'large',
} as const;
