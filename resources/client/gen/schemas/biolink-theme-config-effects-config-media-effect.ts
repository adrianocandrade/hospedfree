...
export type BiolinkThemeConfigEffectsConfigMediaEffect =
  (typeof BiolinkThemeConfigEffectsConfigMediaEffect)[keyof typeof BiolinkThemeConfigEffectsConfigMediaEffect];

export const BiolinkThemeConfigEffectsConfigMediaEffect = {
  none: 'none',
  aurora: 'aurora',
  tv: 'tv',
  blur: 'blur',
