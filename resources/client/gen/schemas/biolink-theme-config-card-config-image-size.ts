...
export type BiolinkThemeConfigCardConfigImageSize =
  (typeof BiolinkThemeConfigCardConfigImageSize)[keyof typeof BiolinkThemeConfigCardConfigImageSize];

export const BiolinkThemeConfigCardConfigImageSize = {
  small: 'small',
  medium: 'medium',
  large: 'large',
} as const;
