...
export type BiolinkThemeConfigBgConfigActiveType =
  (typeof BiolinkThemeConfigBgConfigActiveType)[keyof typeof BiolinkThemeConfigBgConfigActiveType];

export const BiolinkThemeConfigBgConfigActiveType = {
  color: 'color',
  pattern: 'pattern',
  gradient: 'gradient',
  image: 'image',
