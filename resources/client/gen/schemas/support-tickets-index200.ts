...
import type {SupportTicketsIndex200Links} from './support-tickets-index200-links';
import type {SupportTicketsIndex200Meta} from './support-tickets-index200-meta';

export type SupportTicketsIndex200 = {
  data: SupportTicketResource[];
  links: SupportTicketsIndex200Links;
  meta: SupportTicketsIndex200Meta;
};
