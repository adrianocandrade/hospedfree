 ...
 * @nullable
 */
export type CrupdateBookingServiceRequestPaymentMethod =
  | (typeof CrupdateBookingServiceRequestPaymentMethod)[keyof typeof CrupdateBookingServiceRequestPaymentMethod]
  | null;

export const CrupdateBookingServiceRequestPaymentMethod = {
  none: 'none',
  link: 'link',
  pix: 'pix',
  link_and_pix: 'link_and_pix',
} as const;
