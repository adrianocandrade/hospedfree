 ...
 */
import type {AdminHostingSettingsIndex200Data} from './admin-hosting-settings-index200-data';

export type AdminHostingSettingsIndex200 = {
  data: AdminHostingSettingsIndex200Data;
};
