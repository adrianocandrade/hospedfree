...
export type BiolinkAppearanceConfigBoxConfigVariant =
  (typeof BiolinkAppearanceConfigBoxConfigVariant)[keyof typeof BiolinkAppearanceConfigBoxConfigVariant];

export const BiolinkAppearanceConfigBoxConfigVariant = {
  outline: 'outline',
  solid: 'solid',
  glass: 'glass',
