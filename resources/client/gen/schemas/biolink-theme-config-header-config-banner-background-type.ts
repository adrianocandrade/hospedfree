...
export type BiolinkThemeConfigHeaderConfigBannerBackgroundType =
  (typeof BiolinkThemeConfigHeaderConfigBannerBackgroundType)[keyof typeof BiolinkThemeConfigHeaderConfigBannerBackgroundType];

export const BiolinkThemeConfigHeaderConfigBannerBackgroundType = {
  gradient: 'gradient',
  image: 'image',
} as const;
