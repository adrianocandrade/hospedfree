...
export type AdminSupportTicketsUpdateBodyDepartment =
  (typeof AdminSupportTicketsUpdateBodyDepartment)[keyof typeof AdminSupportTicketsUpdateBodyDepartment];

export const AdminSupportTicketsUpdateBodyDepartment = {
  technical: 'technical',
  general: 'general',
  billing: 'billing',
} as const;
