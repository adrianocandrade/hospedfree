...
export type CrupdateBiolinkBodyRulesItemType =
  (typeof CrupdateBiolinkBodyRulesItemType)[keyof typeof CrupdateBiolinkBodyRulesItemType];

export const CrupdateBiolinkBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
