 ...
 */
import type {AdminHostingSettingsHealth200Data} from './admin-hosting-settings-health200-data';

export type AdminHostingSettingsHealth200 = {
  data: AdminHostingSettingsHealth200Data;
};
