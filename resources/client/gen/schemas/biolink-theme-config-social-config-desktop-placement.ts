...
export type BiolinkThemeConfigSocialConfigDesktopPlacement =
  (typeof BiolinkThemeConfigSocialConfigDesktopPlacement)[keyof typeof BiolinkThemeConfigSocialConfigDesktopPlacement];

export const BiolinkThemeConfigSocialConfigDesktopPlacement = {
  badge: 'badge',
  footer: 'footer',
  hidden: 'hidden',
} as const;
