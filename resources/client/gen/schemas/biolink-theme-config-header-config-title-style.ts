...
export type BiolinkThemeConfigHeaderConfigTitleStyle =
  (typeof BiolinkThemeConfigHeaderConfigTitleStyle)[keyof typeof BiolinkThemeConfigHeaderConfigTitleStyle];

export const BiolinkThemeConfigHeaderConfigTitleStyle = {
  text: 'text',
  logo: 'logo',
} as const;
