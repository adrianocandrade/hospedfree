...
export type HostingFilesUpdateBodyOperation =
  (typeof HostingFilesUpdateBodyOperation)[keyof typeof HostingFilesUpdateBodyOperation];

export const HostingFilesUpdateBodyOperation = {
  write: 'write',
  rename: 'rename',
  copy: 'copy',
  move: 'move',
