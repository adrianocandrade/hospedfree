 ...
 */
import type {AdminHostingAccountResources200Data} from './admin-hosting-account-resources200-data';

export type AdminHostingAccountResources200 = {
  data: AdminHostingAccountResources200Data;
};
