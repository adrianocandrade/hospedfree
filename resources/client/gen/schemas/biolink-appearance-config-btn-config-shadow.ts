...
export type BiolinkAppearanceConfigBtnConfigShadow =
  (typeof BiolinkAppearanceConfigBtnConfigShadow)[keyof typeof BiolinkAppearanceConfigBtnConfigShadow];

export const BiolinkAppearanceConfigBtnConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
