 ...
 */
import type {ProviderOperationStatus} from './provider-operation-status';

export type AdminHostingOperationsParams = {
  /**
   * @maxLength 120
   * @nullable
   */
  ...
  /**
   * @nullable
   * @pattern ^(operation|status|created_at):(asc|desc)$
   */
  sort?: string | null;
};
