...
export type GenerateTrackedEventsReport200DataEventsGranularity =
  (typeof GenerateTrackedEventsReport200DataEventsGranularity)[keyof typeof GenerateTrackedEventsReport200DataEventsGranularity];

export const GenerateTrackedEventsReport200DataEventsGranularity = {
  minute: 'minute',
  hour: 'hour',
  day: 'day',
  week: 'week',
