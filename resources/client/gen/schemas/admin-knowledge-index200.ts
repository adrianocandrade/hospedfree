 ...
 */
import type {AdminKnowledgeIndex200Links} from './admin-knowledge-index200-links';
import type {AdminKnowledgeIndex200Meta} from './admin-knowledge-index200-meta';
import type {KnowledgeArticleResource} from './knowledge-article-resource';

export type AdminKnowledgeIndex200 = {
  data: KnowledgeArticleResource[];
  links: AdminKnowledgeIndex200Links;
  meta: AdminKnowledgeIndex200Meta;
};
