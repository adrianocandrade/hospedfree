...
export type BulkCreateLinksBodyRulesItemType =
  (typeof BulkCreateLinksBodyRulesItemType)[keyof typeof BulkCreateLinksBodyRulesItemType];

export const BulkCreateLinksBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
