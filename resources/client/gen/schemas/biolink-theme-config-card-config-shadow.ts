...
export type BiolinkThemeConfigCardConfigShadow =
  (typeof BiolinkThemeConfigCardConfigShadow)[keyof typeof BiolinkThemeConfigCardConfigShadow];

export const BiolinkThemeConfigCardConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
