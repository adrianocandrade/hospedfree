 ...
 * @nullable
 */
export type CrupdateQrCodeBodyDataKeyType =
  | (typeof CrupdateQrCodeBodyDataKeyType)[keyof typeof CrupdateQrCodeBodyDataKeyType]
  | null;

export const CrupdateQrCodeBodyDataKeyType = {
  cpf: 'cpf',
  cnpj: 'cnpj',
  phone: 'phone',
  email: 'email',
