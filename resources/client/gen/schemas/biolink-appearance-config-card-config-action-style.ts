...
export type BiolinkAppearanceConfigCardConfigActionStyle =
  (typeof BiolinkAppearanceConfigCardConfigActionStyle)[keyof typeof BiolinkAppearanceConfigCardConfigActionStyle];

export const BiolinkAppearanceConfigCardConfigActionStyle = {
  button: 'button',
  icon: 'icon',
  text: 'text',
} as const;
