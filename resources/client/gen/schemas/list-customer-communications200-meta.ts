 ...
 */
import type {ListCustomerCommunications200MetaLinksItem} from './list-customer-communications200-meta-links-item';

export type ListCustomerCommunications200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: ListCustomerCommunications200MetaLinksItem[];
  /**
