...
export type BiolinkAppearanceConfigEffectsConfigUsernameEffect =
  (typeof BiolinkAppearanceConfigEffectsConfigUsernameEffect)[keyof typeof BiolinkAppearanceConfigEffectsConfigUsernameEffect];

export const BiolinkAppearanceConfigEffectsConfigUsernameEffect = {
  none: 'none',
  glow: 'glow',
  pulse: 'pulse',
  scanline: 'scanline',
