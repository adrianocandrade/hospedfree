...
export type BiolinkAppearanceConfigFooterConfigBrandSource =
  (typeof BiolinkAppearanceConfigFooterConfigBrandSource)[keyof typeof BiolinkAppearanceConfigFooterConfigBrandSource];

export const BiolinkAppearanceConfigFooterConfigBrandSource = {
  auto: 'auto',
  logo: 'logo',
  avatar: 'avatar',
} as const;
