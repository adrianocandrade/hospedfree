...
import type {HostingOrdersIndex200Links} from './hosting-orders-index200-links';
import type {HostingOrdersIndex200Meta} from './hosting-orders-index200-meta';

export type HostingOrdersIndex200 = {
  data: HostingOrderResource[];
  links: HostingOrdersIndex200Links;
  meta: HostingOrdersIndex200Meta;
};
