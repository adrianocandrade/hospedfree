...
export type UpdateBiolinkWidgetSubmissionBodyStatus =
  (typeof UpdateBiolinkWidgetSubmissionBodyStatus)[keyof typeof UpdateBiolinkWidgetSubmissionBodyStatus];

export const UpdateBiolinkWidgetSubmissionBodyStatus = {
  new: 'new',
  read: 'read',
  archived: 'archived',
} as const;
