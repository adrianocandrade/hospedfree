 ...
 */
import type {BookingAvailabilityException} from './booking-availability-exception';
import type {BookingAvailabilityRule} from './booking-availability-rule';

export type BookingAvailabilityUpdate200 = {
  settings: string;
