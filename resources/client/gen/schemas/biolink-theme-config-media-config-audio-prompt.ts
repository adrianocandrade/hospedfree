 ...
 */
import type {BiolinkThemeConfigMediaConfigAudioPromptFontConfig} from './biolink-theme-config-media-config-audio-prompt-font-config';

export type BiolinkThemeConfigMediaConfigAudioPrompt = {
  enabled?: boolean;
  text?: string;
  textColor?: string;
  fontConfig?: BiolinkThemeConfigMediaConfigAudioPromptFontConfig;
};
