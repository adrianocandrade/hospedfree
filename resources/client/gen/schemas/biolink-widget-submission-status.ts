...
export type BiolinkWidgetSubmissionStatus =
  (typeof BiolinkWidgetSubmissionStatus)[keyof typeof BiolinkWidgetSubmissionStatus];

export const BiolinkWidgetSubmissionStatus = {
  new: 'new',
  read: 'read',
  archived: 'archived',
} as const;
