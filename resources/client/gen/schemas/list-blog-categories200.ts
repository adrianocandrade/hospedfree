...
import type {ListBlogCategories200Links} from './list-blog-categories200-links';
import type {ListBlogCategories200Meta} from './list-blog-categories200-meta';

export type ListBlogCategories200 = {
  data: BlogCategory[];
  links: ListBlogCategories200Links;
  meta: ListBlogCategories200Meta;
};
