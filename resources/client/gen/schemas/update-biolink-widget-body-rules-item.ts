 ...
 */
import type {UpdateBiolinkWidgetBodyRulesItemType} from './update-biolink-widget-body-rules-item-type';

export type UpdateBiolinkWidgetBodyRulesItem = {
  type: UpdateBiolinkWidgetBodyRulesItemType;
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
