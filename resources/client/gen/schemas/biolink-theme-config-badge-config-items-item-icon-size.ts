...
export type BiolinkThemeConfigBadgeConfigItemsItemIconSize =
  (typeof BiolinkThemeConfigBadgeConfigItemsItemIconSize)[keyof typeof BiolinkThemeConfigBadgeConfigItemsItemIconSize];

export const BiolinkThemeConfigBadgeConfigItemsItemIconSize = {
  small: 'small',
  medium: 'medium',
  large: 'large',
} as const;
