...
export type BiolinkAppearanceConfigFooterConfigLinksItemSource =
  (typeof BiolinkAppearanceConfigFooterConfigLinksItemSource)[keyof typeof BiolinkAppearanceConfigFooterConfigLinksItemSource];

export const BiolinkAppearanceConfigFooterConfigLinksItemSource = {
  url: 'url',
  widget: 'widget',
} as const;
