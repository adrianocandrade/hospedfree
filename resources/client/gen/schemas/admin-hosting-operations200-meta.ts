 ...
 */
import type {AdminHostingOperations200MetaLinksItem} from './admin-hosting-operations200-meta-links-item';

export type AdminHostingOperations200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: AdminHostingOperations200MetaLinksItem[];
  /**
