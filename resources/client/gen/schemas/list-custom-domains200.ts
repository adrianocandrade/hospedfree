...
import type {ListCustomDomains200Links} from './list-custom-domains200-links';
import type {ListCustomDomains200Meta} from './list-custom-domains200-meta';

export type ListCustomDomains200 = {
  data: CustomDomain[];
  links: ListCustomDomains200Links;
  meta: ListCustomDomains200Meta;
};
