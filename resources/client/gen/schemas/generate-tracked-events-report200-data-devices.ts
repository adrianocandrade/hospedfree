 ...
 */
import type {GenerateTrackedEventsReport200DataDevicesDataItem} from './generate-tracked-events-report200-data-devices-data-item';

export type GenerateTrackedEventsReport200DataDevices = {
  data: GenerateTrackedEventsReport200DataDevicesDataItem[];
};
