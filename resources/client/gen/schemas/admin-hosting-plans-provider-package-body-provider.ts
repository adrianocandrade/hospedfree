...
export type AdminHostingPlansProviderPackageBodyProvider =
  (typeof AdminHostingPlansProviderPackageBodyProvider)[keyof typeof AdminHostingPlansProviderPackageBodyProvider];

export const AdminHostingPlansProviderPackageBodyProvider = {
  fake: 'fake',
  mofh: 'mofh',
} as const;
