 ...
 */
import type {HostingSslIndex200MetaLinksItem} from './hosting-ssl-index200-meta-links-item';

export type HostingSslIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: HostingSslIndex200MetaLinksItem[];
  /**
