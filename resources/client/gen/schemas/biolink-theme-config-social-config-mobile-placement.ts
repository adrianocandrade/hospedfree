...
export type BiolinkThemeConfigSocialConfigMobilePlacement =
  (typeof BiolinkThemeConfigSocialConfigMobilePlacement)[keyof typeof BiolinkThemeConfigSocialConfigMobilePlacement];

export const BiolinkThemeConfigSocialConfigMobilePlacement = {
  header: 'header',
  footer: 'footer',
  hidden: 'hidden',
} as const;
