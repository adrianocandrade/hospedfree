...
export type BiolinkAppearanceConfigBadgeConfigItemsItemType =
  (typeof BiolinkAppearanceConfigBadgeConfigItemsItemType)[keyof typeof BiolinkAppearanceConfigBadgeConfigItemsItemType];

export const BiolinkAppearanceConfigBadgeConfigItemsItemType = {
  system: 'system',
  custom: 'custom',
} as const;
