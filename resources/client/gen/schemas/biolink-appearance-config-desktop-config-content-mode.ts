...
export type BiolinkAppearanceConfigDesktopConfigContentMode =
  (typeof BiolinkAppearanceConfigDesktopConfigContentMode)[keyof typeof BiolinkAppearanceConfigDesktopConfigContentMode];

export const BiolinkAppearanceConfigDesktopConfigContentMode = {
  stack: 'stack',
  spotlight: 'spotlight',
  columns: 'columns',
} as const;
