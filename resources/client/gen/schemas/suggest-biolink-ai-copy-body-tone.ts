 ...
 * @nullable
 */
export type SuggestBiolinkAiCopyBodyTone =
  | (typeof SuggestBiolinkAiCopyBodyTone)[keyof typeof SuggestBiolinkAiCopyBodyTone]
  | null;

export const SuggestBiolinkAiCopyBodyTone = {
  clear: 'clear',
  friendly: 'friendly',
