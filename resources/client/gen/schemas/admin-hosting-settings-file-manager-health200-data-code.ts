...
export type AdminHostingSettingsFileManagerHealth200DataCode =
  (typeof AdminHostingSettingsFileManagerHealth200DataCode)[keyof typeof AdminHostingSettingsFileManagerHealth200DataCode];

export const AdminHostingSettingsFileManagerHealth200DataCode = {
  ok: 'ok',
  file_manager_requirements_failed: 'file_manager_requirements_failed',
} as const;
