 ...
 */
import type {BookingMailConnectionResource} from './booking-mail-connection-resource';

export type BookingMailConnectionsUpdate200 = {
  data: BookingMailConnectionResource;
};
