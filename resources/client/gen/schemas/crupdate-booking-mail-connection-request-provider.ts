...
export type CrupdateBookingMailConnectionRequestProvider =
  (typeof CrupdateBookingMailConnectionRequestProvider)[keyof typeof CrupdateBookingMailConnectionRequestProvider];

export const CrupdateBookingMailConnectionRequestProvider = {
  platform: 'platform',
  smtp: 'smtp',
  gmail: 'gmail',
  mailgun: 'mailgun',
