...
export type BiolinkAppearanceConfigCardConfigShadow =
  (typeof BiolinkAppearanceConfigCardConfigShadow)[keyof typeof BiolinkAppearanceConfigCardConfigShadow];

export const BiolinkAppearanceConfigCardConfigShadow = {
  none: 'none',
  soft: 'soft',
  strong: 'strong',
  hard: 'hard',
