 ...
 * @nullable
 */
export type CrupdateBiolinkThemeRequestMetadataDevice =
  | (typeof CrupdateBiolinkThemeRequestMetadataDevice)[keyof typeof CrupdateBiolinkThemeRequestMetadataDevice]
  | null;

export const CrupdateBiolinkThemeRequestMetadataDevice = {
  mobile: 'mobile',
  desktop: 'desktop',
  both: 'both',
} as const;
