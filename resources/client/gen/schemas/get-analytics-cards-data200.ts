 ...
 */
import type {GetAnalyticsCardsData200DataItem} from './get-analytics-cards-data200-data-item';

export type GetAnalyticsCardsData200 = {
  data: GetAnalyticsCardsData200DataItem[];
};
