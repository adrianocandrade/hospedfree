...
export type BiolinkAppearanceConfigSocialConfigColorMode =
  (typeof BiolinkAppearanceConfigSocialConfigColorMode)[keyof typeof BiolinkAppearanceConfigSocialConfigColorMode];

export const BiolinkAppearanceConfigSocialConfigColorMode = {
  theme: 'theme',
  brand: 'brand',
