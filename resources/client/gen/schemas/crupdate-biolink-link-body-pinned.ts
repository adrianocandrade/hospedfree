 ...
 * @nullable
 */
export type CrupdateBiolinkLinkBodyPinned =
  | (typeof CrupdateBiolinkLinkBodyPinned)[keyof typeof CrupdateBiolinkLinkBodyPinned]
  | null;

export const CrupdateBiolinkLinkBodyPinned = {
  top: 'top',
  bottom: 'bottom',
} as const;
