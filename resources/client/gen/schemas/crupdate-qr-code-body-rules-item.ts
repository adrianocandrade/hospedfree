 ...
 */
import type {CrupdateQrCodeBodyRulesItemType} from './crupdate-qr-code-body-rules-item-type';

export type CrupdateQrCodeBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: CrupdateQrCodeBodyRulesItemType;
};
