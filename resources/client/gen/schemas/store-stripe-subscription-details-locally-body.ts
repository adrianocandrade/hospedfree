 ...
 */
import type {StoreStripeSubscriptionDetailsLocallyBodyIntentType} from './store-stripe-subscription-details-locally-body-intent-type';

export type StoreStripeSubscriptionDetailsLocallyBody = {
  intent_type: StoreStripeSubscriptionDetailsLocallyBodyIntentType;
  intent_id: string;
