...
export type BiolinkAppearanceConfigBtnConfigVariant =
  (typeof BiolinkAppearanceConfigBtnConfigVariant)[keyof typeof BiolinkAppearanceConfigBtnConfigVariant];

export const BiolinkAppearanceConfigBtnConfigVariant = {
  outline: 'outline',
  solid: 'solid',
  glass: 'glass',
