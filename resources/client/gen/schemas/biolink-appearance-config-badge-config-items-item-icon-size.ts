...
export type BiolinkAppearanceConfigBadgeConfigItemsItemIconSize =
  (typeof BiolinkAppearanceConfigBadgeConfigItemsItemIconSize)[keyof typeof BiolinkAppearanceConfigBadgeConfigItemsItemIconSize];

export const BiolinkAppearanceConfigBadgeConfigItemsItemIconSize = {
  small: 'small',
  medium: 'medium',
  large: 'large',
} as const;
