 ...
 */
import type {GenerateTrackedEventsReport200DataCitiesDataItem} from './generate-tracked-events-report200-data-cities-data-item';

export type GenerateTrackedEventsReport200DataCities = {
  data: GenerateTrackedEventsReport200DataCitiesDataItem[];
};
