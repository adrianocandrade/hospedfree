 ...
 */
import type {ListBiolinkWidgetSubmissions200MetaLinksItem} from './list-biolink-widget-submissions200-meta-links-item';

export type ListBiolinkWidgetSubmissions200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: ListBiolinkWidgetSubmissions200MetaLinksItem[];
  /**
