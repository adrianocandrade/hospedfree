...
export type BiolinkAppearanceConfigBadgeConfigStyle =
  (typeof BiolinkAppearanceConfigBadgeConfigStyle)[keyof typeof BiolinkAppearanceConfigBadgeConfigStyle];

export const BiolinkAppearanceConfigBadgeConfigStyle = {
  inline: 'inline',
  chips: 'chips',
  cards: 'cards',
  icon: 'icon',
