...
export type CrupdateQrCodeBodyRulesItemType =
  (typeof CrupdateQrCodeBodyRulesItemType)[keyof typeof CrupdateQrCodeBodyRulesItemType];

export const CrupdateQrCodeBodyRulesItemType = {
  geo: 'geo',
  device: 'device',
  platform: 'platform',
