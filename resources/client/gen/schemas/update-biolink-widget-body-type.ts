...
export type UpdateBiolinkWidgetBodyType =
  (typeof UpdateBiolinkWidgetBodyType)[keyof typeof UpdateBiolinkWidgetBodyType];

export const UpdateBiolinkWidgetBodyType = {
  image: 'image',
  text: 'text',
  socials: 'socials',
  youtube: 'youtube',
