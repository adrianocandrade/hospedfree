 ...
 */
import type {BiolinkAppearanceConfigBgConfigActiveType} from './biolink-appearance-config-bg-config-active-type';
import type {BiolinkAppearanceConfigBgConfigImageEffect} from './biolink-appearance-config-bg-config-image-effect';

export type BiolinkAppearanceConfigBgConfig = {
  activeType?: BiolinkAppearanceConfigBgConfigActiveType;
  ...
  tint?: number;
  noise?: boolean;
  imageEffect?: BiolinkAppearanceConfigBgConfigImageEffect;
