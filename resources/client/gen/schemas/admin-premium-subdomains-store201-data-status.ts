...
export type AdminPremiumSubdomainsStore201DataStatus =
  (typeof AdminPremiumSubdomainsStore201DataStatus)[keyof typeof AdminPremiumSubdomainsStore201DataStatus];

export const AdminPremiumSubdomainsStore201DataStatus = {
  inactive: 'inactive',
  expired: 'expired',
  paid: 'paid',
