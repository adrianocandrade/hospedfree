 ...
 */
import type {SupportTicketsIndex200MetaLinksItem} from './support-tickets-index200-meta-links-item';

export type SupportTicketsIndex200Meta = {
  /** @minimum 1 */
  current_page: number;
  /**
   * @minimum 1
  ...
  links: SupportTicketsIndex200MetaLinksItem[];
  /**
