 ...
 */
import type {CrupdateBiolinkLinkBodyRulesItemType} from './crupdate-biolink-link-body-rules-item-type';

export type CrupdateBiolinkLinkBodyRulesItem = {
  /** @nullable */
  key?: string | null;
  /**
   * @maxLength 250
   ...
   */
  value?: string | null;
  type?: CrupdateBiolinkLinkBodyRulesItemType;
};
