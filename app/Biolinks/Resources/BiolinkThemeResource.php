 ...
 * @mixin BiolinkTheme
 */
#[SchemaName('BiolinkTheme')]
class BiolinkThemeResource extends JsonResource
{
    public function toArray($request): array
    {
        return [
            'id' => $this->id,
            'model_type' => BiolinkTheme::MODEL_TYPE,
            'name' => $this->name,
            'slug' => $this->slug,
            /** @var 'customizable'|'curated' */
             ...
             *   requiredFeatures?: array<int, 'advanced_appearance'|'desktop_layout'|'model_gallery'|'premium_models'|'background_video'|'profile_audio'|'custom_cursor'|'visual_effects'|'badges'|'custom_badges'|'discord_presence'|'hide_branding'|'custom_css'>,
             *   contentBlueprint?: array<string, mixed>,
             *   seedVersion?: string
             * }|null
             */
