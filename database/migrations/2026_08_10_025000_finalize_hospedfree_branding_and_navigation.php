...
return new class extends Migration {
    ...
    {
        foreach ([
            'branding.logo_dark' => 'images/logo-1.png',
            'branding.logo_light' => 'images/logo-white.png',
            'branding.logo_dark_mobile' => 'images/icon.png',
            'branding.logo_light_mobile' => 'images/icon.png',
            'dashboard.homepage' => 'hosting',
        ] as $name => $value) {
        ...
        foreach ($this->menus() as $position => $menu) {
    ...
    {
        // Reversal is application-level via feature flags and source rollback.
    }
