...
function sizeStyle(size: BreadcrumbsProps['size']): BreadcrumbSizeStyle {
  switch (size) {
    case 'sm':
      return {font: 'text-sm', icon: 'sm', btn: 'sm', minHeight: 'min-h-9'};
    case 'lg':
      return {font: 'text-lg', icon: 'sm', btn: 'md', minHeight: 'min-h-10.5'};
    case 'xl':
      return {font: 'text-xl', icon: 'sm', btn: 'md', minHeight: 'min-h-10.5'};
    default:
      return {
        font: 'text-base',
        icon: 'sm',
