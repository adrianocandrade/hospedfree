...
function DesktopControls({
  ...
  return (
    <div
      ...
      className={clsx('bottom-0 left-0 right-0 p-2', className)}
    >
  ...
  return (
    <Fragment>
      <div
        ...
        onPointerLeave={onPointerLeave}
        onClick={e => e.stopPropagation()}
        className={clsx('left-0 right-0 top-0 px-1.5 pt-1.5 ', className)}
      >
      ...
      <div
        ...
        onPointerLeave={onPointerLeave}
        onClick={e => e.stopPropagation()}
        className={clsx('bottom-0 left-0 right-0 px-3', className)}
      >
